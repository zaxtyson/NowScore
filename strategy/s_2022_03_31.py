...
class SpiderStrategy(BaseStrategy):
    ...
    def _worth_push(self, detail: DetailInfo) -> bool:
        ...
        c2_2 = Condition(
            lambda: meta.guest_win2 > meta.guest_win1 > meta.draw1 > meta.draw2 > meta.host_win1 > meta.host_win2)
        c2_3 = Condition(
            lambda: meta.guest_win2 > meta.guest_win1 > meta.draw2 > meta.draw1 > meta.host_win1 > meta.host_win2)
        c1.add_next(c2_1)
        c2_1.add_next(c2_2, c2_3)
        ...
        # step 4
        c4 = Condition(lambda: detail.bet365 and detail.bet365.instant_host_win >= 1.65)
        c3.add_next(c4)
